...
module.exports = (() => {
  ...
  const getBranchDescription = (branch) => {
    const branchDescriptionAsJson = getBranchInfo(BRANCH_INFO_PARTS.DESCRIPTION, branch);
  ...
  const getBranchOnlyCommits = (maxCommitNumber) => {
    ...
    const branchDescription = JSON.parse(getBranchInfo(BRANCH_INFO_PARTS.DESCRIPTION));
