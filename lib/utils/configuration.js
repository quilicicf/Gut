...
module.exports = (() => {
  ...
  const REOPSITORY_OPTIONS_STRUCTURE = {
    // TODO: replace occurrences of thingies below
  ...
  const getRepositoryOption = (optionPath) => {
    ...
    const optionValue = getOption(repositoryOptionsFilePath, REPOSITORY_OPTION_DEFAULTS, optionPath);
