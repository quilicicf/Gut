...
module.exports = (() => {
  ...
  const getRepositoryOption = (optionPath) => {
    const repositoryOptionsFilePath = path.resolve(git.getTopLevel(), REPOSITORY_OPTIONS_FILE_NAME, optionPath);
    const optionValue = getOption(repositoryOptionsFilePath, REPOSITORY_OPTION_DEFAULTS);
